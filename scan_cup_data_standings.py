...
output_file = r"C:\Users\litia\.gemini\antigravity\tcg-manager\cup_data_standings_scan_results.txt"
...
with open(output_file, 'w', encoding='utf-8') as f:
    ...
    f.write(f"Found {len(matches)} matching files (with <standings>):\n\n")
    for m in matches:
        f.write(m + "\n")
