...
// Content-Security-Policy scoped to the app's real dependencies:
// - Supabase REST/Auth over https and Realtime over wss (NEXT_PUBLIC_SUPABASE_URL
//   is a *.supabase.co host).
